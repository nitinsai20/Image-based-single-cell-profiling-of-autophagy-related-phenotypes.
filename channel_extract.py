...
#GFP_name= enter the name of the GFP files in the format of *GFPname*.tif(file extension is needed), similarly TRITC. 
#important = if you are dont want one of the channels please mention the argument as none. For example, for extracting tritc but not GFP
#the syntax would be = channel_extract("folder_location", "None)
